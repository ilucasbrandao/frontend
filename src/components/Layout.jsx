...
export const Layout = ({ children }) => {
    ...
    const navLinkClass = ({ isActive }) =>
        `block px-3 py-2 rounded-md text-base sm:text-sm font-medium ${
        // Ajuste text-base para mobile
        isActive
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center">
                            {" "}
                            {/* <-- Esconde no mobile */}
                            <span className="text-gray-400 text-sm mr-4 hidden lg:inline">
                                Olá, {user?.email}
                            </span>{" "}
                            {/* Esconde email em telas médias */}
                            <button
